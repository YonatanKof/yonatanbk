		...
		<div class="wrapper">
			...
			<div class="work">
				<Project
					...
					year="2015-2025"
					description="Building brand guides and design systems before they were called this way. Check out Pepperi project below to see an enterprise garde design system implemented using Storybook."
